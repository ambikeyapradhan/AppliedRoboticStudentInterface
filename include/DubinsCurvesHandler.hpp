...
class DubinsCurvesHandler {
    private:
        ...
        std::vector<DubinsLine> discretizeDubinsCurve(double starting_x, double starting_y, double starting_theta, DubinsArc arcs[3]);
    ...
    public:
        ...
        explicit DubinsCurvesHandler(double k_max, double discritizer_size);
